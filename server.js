...
const IDler = {
  botID: "793097025637056512",
  botSecret: "ww5ZygVh7FjWuGUmOGCRSMOE14ihNwap",
  botCallbackURL: "https://marnelcode.glitch.me/callback",
  sunucuID: "771103019211292672",
  sunucuDavet: "https://discord.gg/yXtT8ZTqkx",
  kodLogKanalı: "795980086134177792",
  sahipRolü: "771292883739344898",
  adminRolü: "771106446791147611",
  kodPaylaşımcıRolü: "771289624089198592",
  boosterRolü: "779816758277570610",
  kodPaylaşamayacakRoller: ["771289776896475146", "771294720609353729"],
  hazırAltyapılarRolü: "780772036703551490",
  hazırSistemlerRolü: "780772036703551490",
  htmlKodlarRolü: "771698290915409923",
  ekbilgirolü: "771293257082077216",
  elmasKodlarRolü: "793457030526140436",
  altınKodlarRolü: "771293434479771669",
  normalKodlarRolü: "771293257082077216"
};
...
app.post("/paylasim", (req, res) => {
  ...
  client.channels.cache.get(IDler.kodLogKanalı).send(
    new Discord.MessageEmbed()
      ...
      .addField(
        "<a:levelup:780144771892903957> Kod Bilgileri",
        `<a:sagok4:778543872867303424> **Adı:** ${obj.isim} \n<a:sagok4:778543872867303424> **Açıklaması:** ${obj.desc} \n<a:sagok4:778543872867303424> **Değeri:** ${obj.kod_rank} \n<a:sagok4:778543872867303424> **Paylaşan:** ${obj.k_adi}`
      )
      .addField(
        "<a:levelup:780144771892903957> Kod Sayfası",
        `[Tıkla!](https://marnelcode.glitch.me/${obj.kod_rank}/${obj.id})`
      )
  );
...
client.on("ready", () => {
  const listener = app.listen(process.env.PORT, function() {
    client.user.setActivity(`Marnel Code`, `https://marnelcode.glitch.me/`, {
      type: "WATCHING"
    });
